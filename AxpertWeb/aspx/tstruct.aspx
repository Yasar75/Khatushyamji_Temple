        ...
        <div class="footer d-flex flex-lg-column content p-1 pb-4 pt-0 flex-shrink-0 tstructMainBottomFooter">
            <div class="d-flex flex-column flex-md-row">
                ...
                <div class="text-dark BottomToolbarBar">
                    <a href="javascript:void(0)" id="ftbtn_iSave" title="save" onclick='javascript:FormSubmit();' runat="server" class="btn btn-primary d-inline-flex align-items-center shadow-sm me-2 dwbIvBtnbtm d-none"><span class="material-icons">save</span>Submit</a>
                    <a href="javascript:void(0)" id="ftbtn_iDiscard" title="discard" onclick="javascript:discardLodaData();" runat="server" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center shadow-sm me-2 dwbIvBtnbtm d-none"><span class="material-icons">clear</span>Discard</a>
                    <a href="javascript:void(0)" id="ftbtn_iNew" title="new" onclick='javascript:NewTstruct();' runat="server" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center shadow-sm me-2 dwbIvBtnbtm d-none"><span class="material-icons">add_circle_outline</span>New</a>
                    <a href="javascript:void(0)" id="ftbtn_iRemove" title="delete" onclick='javascript:DeleteTstruct();' runat="server" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center shadow-sm me-2 dwbIvBtnbtm d-none"><span class="material-icons">remove</span>Remove</a>
                    <a href="javascript:void(0)" id="ftbtn_iList" title="listview" runat="server" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center shadow-sm me-2 dwbIvBtnbtm d-none"><span class="material-icons">format_list_bulleted</span>List</a>
