...
public partial class aspx_HomeBuilder : System.Web.UI.Page
{
    public string homeBulider = string.Empty;
    public string globalVars = string.Empty;
    public string homeBuliderImageaPath = string.Empty;
    public string appsessionKey = string.Empty;
    public string nodeApiPath = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["AxMenuStyle"] != null)
            menuStyle = Session["AxMenuStyle"].ToString();
        if (Session["AxHomeBuildAccess"] != null)
            homeBulider = Session["AxHomeBuildAccess"].ToString();
        else
            homeBulider = "developer,administrator";
        if (ConfigurationManager.AppSettings["HomeBuilderImagePath"] != null)
            homeBuliderImageaPath = ConfigurationManager.AppSettings["HomeBuilderImagePath"].ToString();
        if (ConfigurationManager.AppSettings["NodeAPI"] != null)
            nodeApiPath = ConfigurationManager.AppSettings["NodeAPI"].ToString();
