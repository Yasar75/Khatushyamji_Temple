//var form1 = parent.document.getElementById('divHd');
//var form2 = parent.document.getElementById('spHeading');
...
; (function ($, window, document, undefined) {
            ...
            function getButtonsTemplate(settings) {
                var x = document.getElementsByClassName("aiia-wizard-step");
                var y = 'block';
            ...
            function getProgressButtonsTemplate($steps, settings) {
                ...
                var $progessButtonsWrapper = $("" +
                    "<div class='aiia-wizard-progress-buttons-wrapper row'>" +
                        "<div class='col-md-12'>" +
                            "<ul class='nav nav-pills nav-justified aiia-wizard-progress-buttons-placeholder' style='width:60px;height:100px;font-size:12px;'>" +
                            "</ul>" +
                        "</div>" +
                    "</div>" +
                "").css({
                ...
                $.each($steps, function (i, step) {
                    ...
                    var $progressButton = $("" +
                        "<li data-position='" + $step.attr('data-position') + "'><a href='#'><h1 style='font-size:24px;'>" + $step.data('position') + ". </h1>" + $step.find('h1').html() + "</a></li>" +
                    "");
