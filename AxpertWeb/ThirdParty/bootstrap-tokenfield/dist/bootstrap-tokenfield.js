...
/**
 * Enable / Disable Token Field value and label trim
 * @author Prashik
 * @Date   2021-07-28T12:08:56+0530
 */
  ...
  , listen: function () {
      ...
      this.$input
        ...
        .on('autocompleteselect', function (e, ui) {
          //prashik start changes          
          if (_self.createToken( ui.item )) {
          //prashik stop changes            
            _self.$input.val('')
        ...
        case 13: // enter
          ...
          // Create token
            ...
            //if (this.$input.is(document.activeElement) && this.$input.val().length || this.$input.data('edit')) {
              //prashik change start
          if (this.$input.is(document.activeElement) && this.$input.val().length && $(".ui-menu-item-wrapper.ui-state-active").length == 0 || this.$input.data('edit')) {
            //prashik change end
