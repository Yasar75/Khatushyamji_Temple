...
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1000330000005,'F',0,NULL,'admin','2020-08-26','admin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'WebService Timeout','WebService Timeout','WebService Timeout','configtypeWebService Timeout',NULL,'All','F','F','F','T','T','F')
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1226220000004,'F',0,NULL,'superadmin','2020-08-26','superadmin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Iview Button Style','Iview Button Style','New Iview buttons UI can be switched as Modern(Google like UI) / Classic(Classic Bootstrap like UI) . Product default Iview Button UI is  "Modern" Style.','configtypeIview Button Style','','Iview','F','F','F','F','T','F')
>>
<<
...
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1355440000003,'F',0,NULL,'admin','2020-08-26','admin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Show keyboard in Hybrid App','Show keyboard in Hybrid App','An enhancement to make an intuitive UI in Axpert Hybrid App i.e., 
-- based on the "Show keyboard in Hybrid App" key value, user can enable or disable the keyboard for autocomplete fields in tstruct level.
-- By default, value is set as true which makes no difference in the existing feature/functionality.
-- If set false,  keyboard is hidden/disabled along with the drop-down and clear icons. On single click of the field, drop down appears to choose the desired value.
...
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1355440000006,'F',0,NULL,'admin','2020-08-26','admin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Auto Save Draft','Auto Save Draft','If key is set to true and time in millisecs(for ex for 60 secs give 60000 . Note: default time will be 120 seconds/2 minutes if no time is set) then on loading tstruct,it will check if unsaved data is there, if unsaved data  exists it will throw a popup with yes /no buttons.If yes, it will load the unsaved data else it will load a new tstruct.If new tstruct is opened for which key exists,then only if any field is changed,it will push data in redis after the mentioned time  in developer options at regular intervals.','configtypeAuto Save Draft',NULL,'Tstruct','F','F','F','T','F','F')
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1355440000009,'F',0,NULL,'admin','2020-08-26','admin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Grid Scrollbar','Grid Scrollbar','If key is set to true,then if grid dc is there for the tstruct,then horizontal scroll bar will be fixed at the bottom of the page.','configtypeGrid Scrollbar',NULL,'Tstruct','F','F','F','T','F','F')
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1635440000037,'F',0,NULL,'admin','2020-08-26','admin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Enforced Strong Password Policy','General','If key is set to true,Strong Password Policy will work.Details for Enforced Strong Password Policy: Password should be alphanumeric, contains one UpperCharacter, one LowerCharacter with atleast one special character.It will check the following condition if key set to true and if password entered is not matching the condition,then it will throw error.','configtypeEnforced Strong Password Policy',NULL,'Common','F','F','F','F','F','F')
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1984220000001,'F',0,NULL,'superadmin','2020-08-26','superadmin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Mobile Reports as Table','Mobile Reports as Table','Administrator can enable tabular view in mobile instead of cards view','configtypeMobile Reports as Table',NULL,'All','F','F','F','T','T','F')
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1984440000004,'F',0,NULL,'superadmin','2020-08-26','superadmin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'User Manual','General','User can able to access the files through web application which is saved in local folder through User Manual option (located in right sidebar menu)','configtypeUser Manual',NULL,'All','F','F','F','T','T','F')
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid,Cancel,Sourceid,MapName,UserName,Modifiedon,CreatedBy,CreatedOn,Wkid,App_level,App_desc,App_slevel,CancelRemarks,WFRoles,configprops,propcode,description,dupchk,context,ptype,caction,chyperlink,cfields,alltstructs,alliviews,alluserroles) VALUES (1984880000036,'F',0,NULL,'superadmin','2020-08-26','superadmin','2020-08-26',NULL,1,1,NULL,NULL,NULL,'Notification Time Interval','General','Notification feature can be enabled at Application level by adding Developer Option "Notification Time Interval" , with values in minutes for time intervals as 1, 2, 3 , 4 etc. Once this key is added, long running web services/backend scheduled jobs completion can be notified to the user with given time intervals, so that user would be able to do other operations during long running web services/backend jobs.','configtypeNotification Time Interval',NULL,'All','F','F','F','T','T','F')
>>
<<
...
>>
<<
create view vw_publish_list as 
select distinct format(a.createdon,'dd/MM/yyyy' ) createdon,coalesce(a.publishedby,'NA') publishedby,coalesce(a.publishedto,'NA')publishedto,
SUBSTRING(stuff((select ','+transid from axpublishreport b where format(a.createdon,'dd/MM/yyyy' ) =format(b.createdon,'dd/MM/yyyy' ) 
and coalesce(a.publishedby,'NA')= coalesce(b.publishedby,'NA')
and coalesce(a.publishedto,'NA') = coalesce(b.publishedto,'NA')
for xml path('')),1,1,''),1,300)+'...' dtls
