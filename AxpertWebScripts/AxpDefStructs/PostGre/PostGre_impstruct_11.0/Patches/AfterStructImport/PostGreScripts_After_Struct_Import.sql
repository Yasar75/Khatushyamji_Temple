...
>>
<<
CREATE TABLE axdsignconfig (
	axdsignconfigid numeric(16) NOT NULL,
	...
	stransid varchar(10) NULL,
	printdocname varchar(50) NULL,
	docnamefield varchar(50) NULL,
	pusername varchar(100) NULL,
	ordno varchar(10) NULL,
	doctype varchar(50) NULL,
	axpmailid numeric(15) NULL,
	mailid varchar(100) NULL,
	mobileno varchar(10) NULL,
	sendemail varchar(1) NULL,
	sendsms varchar(1) NULL,
	prolename varchar(50) NULL,
	rolename varchar(60) NULL,
	CONSTRAINT aglaxdsignconfigid PRIMARY KEY (axdsignconfigid)
)
>>
<<
...
for each row execute procedure fn_AX_HOMEBUILD_MASTER(); end;
>>
<<
create trigger ax_homebuild_master_bir before
insert
    on
    ax_homebuild_master for each row execute function fn_ax_homebuild_master();
>>
<<
...
>>
<<
CREATE OR REPLACE FUNCTION fn_ax_page_templates()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
>>
<<
create trigger ax_page_template_bir before
insert
    on
    ax_page_templates for each row execute function int9.fn_ax_page_templates()
>>
<<
...
<<
CREATE OR REPLACE FUNCTION fn_ax_page_saved()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
>>
<<
create trigger ax_page_saved_bir before
insert
    on
    ax_page_saved for each row execute function fn_ax_page_saved()
>>
<<
...
<<
CREATE TABLE axpexchange (
	axpexchangeid numeric(16) NOT NULL,
	cancel varchar(1) NULL,
	sourceid numeric(16) NULL,
	mapname varchar(20) NULL,
	username varchar(50) NULL,
	...
	idfield varchar(30) NULL,
	adxinout varchar(1) NULL,
	ftphost varchar(180) NULL,
	ftpname varchar(10) NULL,
	ftppwd varchar(10) NULL,
	ftp varchar(200) NULL,
	formatfile text NULL,
	"extension" varchar(5) NULL,
	ordno numeric(3) NULL,
	cond varchar(200) NULL,
	outfolder varchar(200) NULL,
	infolder varchar(200) NULL,
	succfolder varchar(200) NULL,
	failfolder varchar(200) NULL,
	archsuccfolder varchar(200) NULL,
	archfailfolder varchar(200) NULL,
	CONSTRAINT aglaxpexchangeid PRIMARY KEY (axpexchangeid)
);
>>
<<
CREATE TABLE axintelliviewdet (
	axintelliviewdetid numeric(16) NOT NULL,
	cancel varchar(1) NULL,
	sourceid numeric(16) NULL,
	mapname varchar(20) NULL,
	username varchar(50) NULL,
	...
	ivname varchar(100) NULL,
	ax_user varchar(100) NULL,
	companyname varchar(100) NULL,
	reportname varchar(100) NULL,
	filtername varchar(100) NULL,
	filtervalues varchar(100) NULL,
	reporttype varchar(1) NULL,
	pusername varchar(30) NULL,
	ppassword varchar(30) NULL,
	CONSTRAINT aglaxintelliviewdetid PRIMARY KEY (axintelliviewdetid)
);
>>
<<
...
>>
<<
INSERT INTO axpstructconfigprops (axpstructconfigpropsid, cancel, sourceid, mapname, username, modifiedon, createdby, createdon, wkid, app_level, app_desc, app_slevel, cancelremarks, wfroles, configprops, propcode, description, dupchk, context, ptype, caction, chyperlink, cfields, alltstructs, alliviews, alluserroles) VALUES(1355440000009, 'F', 0, NULL, 'admin', '2022-12-25 22:29:56.490', 'admin', '2022-12-25 22:29:56.490', NULL, 1, 1, NULL, NULL, NULL, 'Grid Scrollbar', 'Grid Scrollbar', 'If key is set to true,then if grid dc is there for the tstruct,then horizontal scroll bar will be fixed at the bottom of the page.', 'configtypeGrid Scrollbar', NULL, 'Tstruct', 'F', 'F', 'F', 'T', 'F', 'F');
>>
<<
