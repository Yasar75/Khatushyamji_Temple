...
>>
<<
CREATE OR REPLACE FUNCTION fn_iconfiguration() RETURNS TRIGGER
AS $iconfiguration$ 
declare
v_cnt numeric(2);
v_sql varchar(4000);
...
$iconfiguration$ LANGUAGE plpgsql;
>>
<<
create trigger TR_AXPCONFIGS_IVIEWS   
before insert or update or delete on iconfiguration       
for each row

execute procedure fn_iconfiguration();
...
Insert into AXPSTRUCTCONFIGPROPS
   (AXPSTRUCTCONFIGPROPSID, CANCEL, SOURCEID, USERNAME, MODIFIEDON, CREATEDBY, CREATEDON, APP_LEVEL, APP_DESC, CONFIGPROPS, PROPCODE, DUPCHK, PTYPE, CACTION, CHYPERLINK, CFIELDS, ALLTSTRUCTS, ALLIVIEWS, ALLUSERROLES)
 Values
   (1386770000000, 'F', 0, 'admin', TO_DATE('06/05/2019 07:33:02', 'MM/DD/YYYY HH24:MI:SS'), 'admin', TO_DATE('06/05/2019 07:33:02', 'MM/DD/YYYY HH24:MI:SS'), 1, 1, 'Save Image in DB', 'SaveImage', 'configtypeSave Image in DB', 'Tstruct', 'F', 'F', 'T', 'T', 'T', 'F')
   >>
   <<
Insert into AXPSTRUCTCONFIGPROPS
   (AXPSTRUCTCONFIGPROPSID, CANCEL, SOURCEID, USERNAME, MODIFIEDON, CREATEDBY, CREATEDON, APP_LEVEL, APP_DESC, CONFIGPROPS, PROPCODE, DUPCHK, PTYPE, CACTION, CHYPERLINK, CFIELDS, ALLTSTRUCTS, ALLIVIEWS, ALLUSERROLES)
